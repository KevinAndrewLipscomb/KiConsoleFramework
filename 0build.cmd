...
echo.
echo *
echo * Make sure any instance of Visual Studio that has touched KiConsoleFramework.sln has been shut down.
echo *
pause
echo.
...
echo -- Removing solution's node_modules folder(s)...
%CommonCommandStartForFolders% node_modules %CommonCommandEndForFolders%
...
echo.
echo DESCENDING INTO PROJECT App...
pushd KiConsoleFramework
echo.
...
echo.
echo RETURNING TO SOLUTION LEVEL...
popd
echo.
...
echo.
echo *
echo * KiConsoleFramework.sln will now open in Visual Studio.  Manually launch a Build, then perform the recommended runtime
echo * assemblyBinding redirect procedure, if any.
echo *
pause
KiConsoleFramework.sln
echo.
echo *
